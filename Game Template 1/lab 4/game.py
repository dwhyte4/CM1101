...
def remove_punct(text):
    ...
    return no_punct # The pass statement does nothing. Replace it with the body of your function.
...
def print_menu_line(direction, leads_to):
    ...
    """
    menu_line = ("Go ",direction.upper()," to ",leads_to+".")
    print (remove_punct(menu_line))
...
def print_menu(exits):
    ...
    """
    print("You can:")
    for no_exit in exits:
        print_menu_line(no_exit,exit_leads_to(exits,no_exit))
